...
namespace chess
{
    ...
    static const auto [BB_DIAG_MASKS, BB_DIAG_ATTACKS] = _attack_table({-9, -7, 7, 9});
    static const auto [BB_FILE_MASKS, BB_FILE_ATTACKS] = _attack_table({-8, 8});
    static const auto [BB_RANK_MASKS, BB_RANK_ATTACKS] = _attack_table({-1, 1});
